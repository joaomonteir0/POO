...
public class exercicio {
    ...
    public static void main(String[] args) {
        ...
        livroEle.add(new LivroEletronico("Harry Banana"));
        livroEle.add(new LivroEletronico("Senhor dos Arroios", "Joaquina")); 
        livroEle.add(new LivroEletronico("Ananás nos Tronos"));
        int op;
        while(true){
            ...
            System.out.println("8 - lista livros eletrónicos disponíveis");
            System.out.println("9 - requisitar ebook");
