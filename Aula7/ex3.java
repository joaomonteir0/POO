...
public class ex3 {
    public static void main(String[] args) {
        ...
        Quarto qdhA = new Quarto("qdhA", "Quarto de Hotel A", "Alvor", 100, 4.5, true, "single");
        Quarto qdhB = new Quarto("qdhB", "Quarto de Hotel B", "Oura", 130, 5.0, false, "double");
    ...
    private static void addQuartoDeHotel(Agencia agencia, Scanner scanner) {
        try {
            ...
            Quarto qdh = new Quarto(codigo, nome, local, preco, avaliacao, disponivel.equals("s"),
                    tipo);
